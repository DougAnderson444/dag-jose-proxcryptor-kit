...
var _Contacts_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".card-container.svelte-1uzs6ik{margin:1em 0}.data-entry.svelte-1uzs6ik{display:flex;padding:0.5em;flex-direction:column;margin:1.62em}.item.svelte-1uzs6ik{flex:1;margin:0.5em 0;padding:0.5em 0}input.svelte-1uzs6ik{padding:1.62em;margin:1.62em 0;width:100%}")();
var DAGJose_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".main.svelte-1ohwnyw{width:100%;margin-top:var(--column-margin-top);padding:var(--column-margin-top);line-height:1;background-color:#e0ede0}")();
var browser = {};
