import { SvelteComponent, init, safe_not_equal, element, svg_element, claim_element, children, claim_svg_element, detach, attr, xlink_attr, insert_hydration, append_hydration, noop, create_slot, create_component, space, claim_component, claim_space, toggle_class, mount_component, listen, action_destroyer, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, destroy_component, run_all, add_render_callback, create_bidirectional_transition, fade, group_outros, check_outros, createEventDispatcher, null_to_empty, set_style, src_url_equal, set_input_value, add_resize_listener, is_function, onMount, globals, text, claim_text, set_data, binding_callbacks, empty, bind, add_flush_callback } from "./vendor-87cb2300.js";
var app = "";
...
function create_fragment$4(ctx) {
  ...
  return {
    ...
    h() {
      attr(div0, "class", "bar1 svelte-g3kmxi");
      attr(div1, "class", "bar2 svelte-g3kmxi");
      attr(div2, "class", "bar3 svelte-g3kmxi");
      attr(div3, "class", "menu-icon svelte-g3kmxi");
      attr(div4, "class", "container svelte-g3kmxi");
      toggle_class(div4, "change", ctx[0]);
      attr(div5, "class", "svelte-g3kmxi");
      toggle_class(div5, "mask", ctx[0]);
      attr(div6, "class", "sidenav svelte-g3kmxi");
...
var WalletSelectorIcons_svelte_svelte_type_style_lang = "";
...
function create_fragment$3(ctx) {
  ...
  let if_block3 = ctx[0] === "unplug" && create_if_block$3();
...
var ConnectorInside_svelte_svelte_type_style_lang = "";
...
let placeholder$1 = "Enter Wallet Url";
const INPUT_URL = "INPUT_URL";
function instance$2($$self, $$props, $$invalidate) {
  let popupIcon;
  let connectionIcon;
  let { wallet } = $$props;
  let { inputUrl = "https://peerpiper.github.io/iframe-wallet-engine/" } = $$props;
...
class Web3WalletMenu extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { inputUrl: 1, wallet: 0 });
  }
}
var Web3WalletMenu$1 = Web3WalletMenu;
var _Connector_svelte_svelte_type_style_lang = "";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      var _a;
      attr(div, "class", div_class_value = null_to_empty(!((_a = ctx[0]) == null ? void 0 : _a.keepPopup) ? "action dim" : "action") + " svelte-1gf2ryb");
    },
    m(target, anchor) {
      insert_hydration(target, div, anchor);
      mount_component(iconbutton, div, null);
    ...
    p(ctx2, dirty) {
      ...
      iconbutton.$set(iconbutton_changes);
      if (!current || dirty & 1 && div_class_value !== (div_class_value = null_to_empty(!((_a = ctx2[0]) == null ? void 0 : _a.keepPopup) ? "action dim" : "action") + " svelte-1gf2ryb")) {
        attr(div, "class", div_class_value);
      }
    },
    i(local) {
...
function create_default_slot(ctx) {
  let span;
  let t_value = ctx[9].loading || !ctx[3] ? "Loading..." : "Load";
  let t;
  let span_class_value;
  return {
    c() {
    ...
    h() {
      var _a;
      attr(span, "class", span_class_value = null_to_empty(((_a = ctx[0]) == null ? void 0 : _a.address) ? " connected " : " disconnected ") + " svelte-1gf2ryb");
    },
    m(target, anchor) {
      insert_hydration(target, span, anchor);
      append_hydration(span, t);
    ...
    p(ctx2, dirty) {
      var _a;
      if (dirty & 520 && t_value !== (t_value = ctx2[9].loading || !ctx2[3] ? "Loading..." : "Load"))
        set_data(t, t_value);
      if (dirty & 1 && span_class_value !== (span_class_value = null_to_empty(((_a = ctx2[0]) == null ? void 0 : _a.address) ? " connected " : " disconnected ") + " svelte-1gf2ryb")) {
        attr(span, "class", span_class_value);
      }
    },
    d(detaching) {
...
function create_fragment(ctx) {
  ...
  let dispose;
  logo = new Logo({});
  let if_block = (((_a = ctx[0]) == null ? void 0 : _a.address) || ctx[1]) && create_if_block(ctx);
  iconbutton = new WalletSelectorIcons({
    props: {
      icon: ctx[10],
  ...
  return {
    ...
    h() {
      ...
      attr(div2, "class", div2_class_value = null_to_empty(((_a2 = ctx[9]) == null ? void 0 : _a2.loading) ? "action dim" : ((_b = ctx[0]) == null ? void 0 : _b.address) ? " connected " : " disconnected ") + " svelte-1gf2ryb");
      attr(div3, "class", "actions svelte-1gf2ryb");
      attr(div4, "class", "top svelte-1gf2ryb");
      set_style(div4, "--topOffsetHeight", ctx[5]);
      add_render_callback(() => ctx[20].call(div4));
      attr(iframe_1, "title", "Web Wallet");
      if (!src_url_equal(iframe_1.src, iframe_1_src_value = ctx[3]))
        attr(iframe_1, "src", iframe_1_src_value);
      set_style(iframe_1, "width", "100%");
      set_style(iframe_1, "height", "100%");
      attr(iframe_1, "allow", iframe_1_allow_value = "clipboard-write 'self' " + ctx[3]);
      attr(iframe_1, "class", "svelte-1gf2ryb");
      attr(div5, "class", "iframe svelte-1gf2ryb");
      set_style(div5, "height", ctx[7] + "px");
      attr(div6, "class", "url-input svelte-1gf2ryb");
      set_style(div6, "height", "calc(var(--spacing) * 2 + " + ctx[5] + "px + " + ctx[7] + "px + 2px)");
      set_style(div6, "--url-input-width", "calc(var(--spacing) * 2 + " + ctx[8] + "px + 2px)");
      set_style(div6, "--url-input-min-width", ctx[6] + "px");
    },
    m(target, anchor) {
      insert_hydration(target, div6, anchor);
      append_hydration(div6, div4);
      ...
      append_hydration(div3, div2);
      mount_component(iconbutton, div2, null);
      div4_resize_listener = add_resize_listener(div4, ctx[20].bind(div4));
      append_hydration(div6, t4);
      append_hydration(div6, div5);
      append_hydration(div5, iframe_1);
      ctx[21](iframe_1);
      ...
      if (!mounted) {
        dispose = [
          ...
          listen(input, "focus", ctx[16]),
          listen(input, "blur", ctx[17]),
    ...
    p(ctx2, [dirty]) {
      ...
      if (((_a2 = ctx2[0]) == null ? void 0 : _a2.address) || ctx2[1]) {
        if (if_block) {
          if_block.p(ctx2, dirty);
          if (dirty & 3) {
            transition_in(if_block, 1);
      ...
      iconbutton.$set(iconbutton_changes);
      if (!current || dirty & 513 && div2_class_value !== (div2_class_value = null_to_empty(((_b = ctx2[9]) == null ? void 0 : _b.loading) ? "action dim" : ((_c = ctx2[0]) == null ? void 0 : _c.address) ? " connected " : " disconnected ") + " svelte-1gf2ryb")) {
        attr(div2, "class", div2_class_value);
      }
      if (!current || dirty & 32) {
        set_style(div4, "--topOffsetHeight", ctx2[5]);
      }
      if (!current || dirty & 8 && !src_url_equal(iframe_1.src, iframe_1_src_value = ctx2[3])) {
        attr(iframe_1, "src", iframe_1_src_value);
      }
      if (!current || dirty & 8 && iframe_1_allow_value !== (iframe_1_allow_value = "clipboard-write 'self' " + ctx2[3])) {
        attr(iframe_1, "allow", iframe_1_allow_value);
      }
      if (!current || dirty & 128) {
        set_style(div5, "height", ctx2[7] + "px");
      }
      if (!current || dirty & 160) {
        set_style(div6, "height", "calc(var(--spacing) * 2 + " + ctx2[5] + "px + " + ctx2[7] + "px + 2px)");
      }
      if (!current || dirty & 256) {
        set_style(div6, "--url-input-width", "calc(var(--spacing) * 2 + " + ctx2[8] + "px + 2px)");
      }
      if (!current || dirty & 64) {
        set_style(div6, "--url-input-min-width", ctx2[6] + "px");
      }
    },
    i(local) {
      if (current)
...
function instance($$self, $$props, $$invalidate) {
  ...
  let connectionIcon;
  let { wallet } = $$props;
  let { inputUrl = "http://localhost:8089/" } = $$props;
  let src = inputUrl;
  let iframe;
  let focused;
...
class Connector extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, { wallet: 0, inputUrl: 1 });
  }
}
...
//# sourceMappingURL=index-9ac9e207.js.map
